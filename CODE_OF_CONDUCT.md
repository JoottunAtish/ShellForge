...
Shellforge exists to teach people who are scared of the terminal. That purpose sets
the tone for the project: **assume the other person is learning, and act like it.**
...
Behaviour that builds this project:

- Being patient with beginners. "How do I open a terminal" is a legitimate question
  here, and answering it well is the entire point of the project.
- Giving and accepting constructive feedback on the work, not the person.
- Saying "I was wrong" when you were.
- Explaining the reasoning behind a review comment, not just the verdict.
- Focusing on what is best for the people trying to learn.

Behaviour that is not acceptable:

- Condescension toward beginners. Telling someone to "just read the man page", or
  treating a basic question as an imposition, is the exact attitude this project was
...
with the people involved for a specified period. Violating these terms may lead to a
